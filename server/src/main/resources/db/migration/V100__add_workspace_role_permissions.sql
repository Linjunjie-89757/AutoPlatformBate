...
CREATE INDEX IF NOT EXISTS idx_permission_module
    ON tb_sys_permission (module_code, sort_order);
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_workspace_role_permission
    ON tb_sys_workspace_role_permission (role_id, permission_code);
CREATE INDEX IF NOT EXISTS idx_workspace_role_permission_code
    ON tb_sys_workspace_role_permission (permission_code);
