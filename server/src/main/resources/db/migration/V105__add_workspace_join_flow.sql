...
CREATE INDEX IF NOT EXISTS idx_workspace_join_application_applicant
    ON tb_sys_workspace_join_application(applicant_user_id, status, created_at);
CREATE INDEX IF NOT EXISTS idx_workspace_join_application_workspace
    ON tb_sys_workspace_join_application(workspace_id, status, created_at);
...
CREATE UNIQUE INDEX IF NOT EXISTS uk_workspace_invitation_hash
    ON tb_sys_workspace_invitation(invite_code_hash);
CREATE INDEX IF NOT EXISTS idx_workspace_invitation_workspace
    ON tb_sys_workspace_invitation(workspace_id, status, expires_at);
