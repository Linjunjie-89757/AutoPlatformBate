...
public class AiGenerationTaskResponseSupport {
    ...
    AiGenerationTaskResponse toResponse(AiGenerationTaskEntity entity, WorkspaceEntity workspace, Map<Long, UserEntity> userMap, boolean includeEvents) {
        ...
        return new AiGenerationTaskResponse(
                ...
                entity.getFailedStage(),
                entity.getErrorCode(),
                entity.getSelfCheckStatus(),
                entity.getSelfCheckAttemptCount() == null ? 0 : entity.getSelfCheckAttemptCount(),
                entity.getHasWarnings() != null && entity.getHasWarnings() == 1,
                readValue(entity.getWarningCodesJson(), new TypeReference<List<String>>() {}, List.of()),
                entity.getTotalReviewBatches() == null ? 0 : entity.getTotalReviewBatches(),
                entity.getCompletedReviewBatches() == null ? 0 : entity.getCompletedReviewBatches(),
                entity.getFailedReviewBatches() == null ? 0 : entity.getFailedReviewBatches(),
                entity.getReviewedCaseCount() == null ? 0 : entity.getReviewedCaseCount(),
                entity.getSupplementedCaseCount() == null ? 0 : entity.getSupplementedCaseCount(),
                entity.getCoverageCompleteness(),
                ...
                entity.getProvider(),
                entity.getModel(),
                entity.getGenerationProvider(),
                entity.getGenerationModel(),
                entity.getGenerationPromptVersion(),
                entity.getGenerationPromptHash(),
                entity.getGenerationTemperature(),
                entity.getReviewProvider(),
                entity.getReviewModel(),
                entity.getReviewPromptVersion(),
                entity.getReviewPromptHash(),
                entity.getReviewTemperature(),
                entity.getInputMode(),
                entity.getImageDigest(),
                entity.getImageCount() == null ? 0 : entity.getImageCount(),
                entity.getInputTokenCount(),
                entity.getOutputTokenCount(),
                entity.getReviewInputTokenCount(),
                entity.getReviewOutputTokenCount(),
