...
const workspaceId = 1;
const envId = 15;
const scenarioModuleId = 6;
const suiteName = '风控中心-回归套件';
const suiteModuleName = '风控中心';
const description = '由 Codex 生成，覆盖风控中心已确认的只读查询场景。';
...
VALUES (${workspaceId}, NULL, ${sqlString(suiteModuleName)}, 40);
`);
  moduleId = scalar(`
SELECT id
FROM tb_api_execution_suite_module
...
INSERT INTO tb_api_execution_suite (
  ...
  1, 300000, 0, 0,
  0, NULL, NULL, 'CODEX_RISK_CENTER', NULL,
