...
import { AppSwitch, AttachmentFileWall, confirmDelete, type AttachmentFileWallItem } from '@/shared/ui'
    ...
    <div v-else class="tp-execution__body">
      ...
      <main class="tp-execution__main">
        ...
        <footer class="tp-execution__actions">
          ...
          <label><AppSwitch v-model="autoNext" label="自动下一条" active-color="#0ea5e9" />自动下一条</label><span />
...
.tp-execution__actions { display: flex; height: 56px; flex: 0 0 auto; align-items: center; gap: 10px; padding: 0 20px; border-top: 1px solid #e5e6eb; background: #fff; }.tp-execution__actions > button { display: flex; height: 32px; align-items: center; gap: 4px; padding: 0 12px; border: 1px solid #e5e6eb; border-radius: 8px; color: #4e5969; background: #fff; font-size: 13px; cursor: pointer; }.tp-execution__actions > button:disabled { color: #c9cdd4; cursor: not-allowed; opacity: .7; }.tp-execution__actions > code { min-width: 40px; color: #86909c; font-family: Cousine, ui-monospace, monospace; font-size: 13px; text-align: center; }.tp-execution__actions > code strong { color: #1d2129; }.tp-execution__actions > i { width: 1px; height: 20px; background: #e5e6eb; }.tp-execution__actions > span { flex: 1; }.tp-execution__actions label { display: flex; align-items: center; gap: 6px; color: #86909c; font-size: 12px; }.tp-execution__actions > button.is-defect:hover { border-color: #f53f3f; color: #f53f3f; }.tp-execution__actions > button.is-blocked { border-color: #ffd595; color: #ff7d00; background: #fff3e8; font-weight: 500; }.tp-execution__actions > button.is-failed { border-color: #fbbbbb; color: #f53f3f; background: #ffe8e8; font-weight: 500; }.tp-execution__actions > button.is-passed { padding: 0 18px; border: 0; color: #fff; background: #00b42a; font-weight: 600; }
