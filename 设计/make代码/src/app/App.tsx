...
function CaseListPage({onViewCase,onExecute}:{onViewCase:(c:TestCase)=>void;onExecute:(c:TestCase)=>void}){
                ...
                <TR key={c.id} active={selected.includes(c.id)}>
                  ...
                  <TD align="right">
                    <div className="flex items-center justify-end">
                      ...
                      <IBtn icon={Play} label="执行" onClick={()=>onExecute(c)}/>
...
function CaseDrawer({case_:c,onClose,onExecute}:{case_:TestCase|null;onClose:()=>void;onExecute:(c:TestCase)=>void}){
      ...
      <div className="relative flex flex-col overflow-hidden" style={{width:680,backgroundColor:"#fff",boxShadow:"-4px 0 24px rgba(0,0,0,0.12)"}}>
        ...
        <div className="flex items-start justify-between px-6 py-4 flex-shrink-0" style={{borderBottom:`1px solid ${T.border}`}}>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <PBtn icon={Play} onClick={()=>{onClose();onExecute(c);}}>执行用例</PBtn>
...
function CasesModule({nav,onNavigate}:{nav:ActiveNav;onNavigate:(k:ActiveNav)=>void}){
  ...
  // Full-page takeover: case execution workstation
  if(execCase){
    return <CaseExecWorkstation initCase={execCase} allCases={CASES} onBack={()=>setExecCase(null)}/>;
  }
  ...
  return(
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      {nav==="cases-list"&&<CaseListPage onViewCase={setCaseDrawer} onExecute={c=>{setCaseDrawer(null);setExecCase(c);}}/>}
      ...
      {caseDrawer&&<CaseDrawer case_={caseDrawer} onClose={()=>setCaseDrawer(null)} onExecute={c=>{setCaseDrawer(null);setExecCase(c);}}/>}
  ...
  return(
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {page==="scenarios"&&<SceneManagement/>}
